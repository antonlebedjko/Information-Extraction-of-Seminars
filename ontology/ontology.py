...
We tokenize an email. We delete any non words in an email.
We remove any words that have only 1 or 2 chars in them.
We remove the stop words (like the, an, a...). After we cleaned everything, what is no needed,
